...
function modal(triggerOpenBtnSelectors, modalElSelector) {
  var triggerOpenBtns = document.querySelectorAll(triggerOpenBtnSelectors);
  var modalEl = document.querySelector(modalElSelector);
  triggerOpenBtns.forEach(function (triggerEl) {
