...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_feedbackForm__WEBPACK_IMPORTED_MODULE_1__["default"])(".form", "SOME-URL"); // todo add URL for posting
});
...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./validate */ "./src/js/modules/validate.js");
...
function feedbackForm(formSelector, url) {
  ...
  var formElems = document.querySelectorAll(formSelector);
  formElems.forEach(function (formEl) {
    formEl.addEventListener("submit", function _callee(event) {
      var formData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (Object(_validate__WEBPACK_IMPORTED_MODULE_4__["default"])(formEl) === 1) {
...
function modal(triggerOpenBtnSelector, modalElSelector) {
  var triggerOpenBtns = document.querySelectorAll(triggerOpenBtnSelector);
...
/* harmony import */ var validate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! validate */ "./node_modules/validate/build/schema.js");
/* harmony import */ var validate__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(validate__WEBPACK_IMPORTED_MODULE_10__);
...
var validateSchema = new validate__WEBPACK_IMPORTED_MODULE_10___default.a({
  name: {
    type: String,
    required: true,
    length: {
...
function tryValidate(formEl) {
  var nameField = formEl.querySelector("input[name='user_name']");
  var phoneField = formEl.querySelector("input[name='user_phone']");
  resetErrorValidate();
  ...
  var errors = validateSchema.validate({
  ...
  if (Object.keys(customErrorObj).length !== 0) {
    ...
    if (customErrorObj["phone"]) {
      var _errorEl = document.createElement("div");

      _errorEl.className = "error";
      _errorEl.textContent = customErrorObj["phone"];
      phoneField.after(_errorEl);
  ...
  function resetErrorValidate() {
    formEl.querySelectorAll(".error").forEach(function (errorEl) {
      errorEl.remove();
    });
