...
/***/ "./node_modules/@eivifj/dot/index.js":
/*!*******************************************!*\
  !*** ./node_modules/@eivifj/dot/index.js ***!
  \*******************************************/
...
/***/ "./node_modules/validate/build/error.js":
/*!**********************************************!*\
  !*** ./node_modules/validate/build/error.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./node_modules/validate/build/messages.js":
/*!*************************************************!*\
  !*** ./node_modules/validate/build/messages.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./node_modules/validate/build/property.js":
/*!*************************************************!*\
  !*** ./node_modules/validate/build/property.js ***!
  \*************************************************/
/*! no static exports found */
...
var _error2 = _interopRequireDefault(__webpack_require__(/*! ./error */ "./node_modules/validate/build/error.js"));

var _utils = __webpack_require__(/*! ./utils */ "./node_modules/validate/build/utils.js");
...
/***/ "./node_modules/validate/build/schema.js":
/*!***********************************************!*\
  !*** ./node_modules/validate/build/schema.js ***!
  \***********************************************/
/*! no static exports found */
...
var _dot = _interopRequireDefault(__webpack_require__(/*! @eivifj/dot */ "./node_modules/@eivifj/dot/index.js"));

var _typecast = _interopRequireDefault(__webpack_require__(/*! typecast */ "./node_modules/typecast/index.js"));

var _property = _interopRequireDefault(__webpack_require__(/*! ./property */ "./node_modules/validate/build/property.js"));

var _messages = _interopRequireDefault(__webpack_require__(/*! ./messages */ "./node_modules/validate/build/messages.js"));

var _validators = _interopRequireDefault(__webpack_require__(/*! ./validators */ "./node_modules/validate/build/validators.js"));

var _error = _interopRequireDefault(__webpack_require__(/*! ./error */ "./node_modules/validate/build/error.js"));
...
/***/ "./node_modules/validate/build/utils.js":
/*!**********************************************!*\
  !*** ./node_modules/validate/build/utils.js ***!
  \**********************************************/
/*! no static exports found */
...
var _componentType = _interopRequireDefault(__webpack_require__(/*! component-type */ "./node_modules/component-type/index.js"));
...
/***/ "./node_modules/validate/build/validators.js":
/*!***************************************************!*\
  !*** ./node_modules/validate/build/validators.js ***!
  \***************************************************/
/*! no static exports found */
...
/*!************************!*\
  !*** ./src/js/main.js ***!
  \************************/
/*! exports provided: urlServer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "urlServer", function() { return urlServer; });
...
/***/ "./src/js/modules/calcFeedbackForm.js":
/*!********************************************!*\
  !*** ./src/js/modules/calcFeedbackForm.js ***!
  \********************************************/
...
/* harmony import */ var _feedbackForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./feedbackForm */ "./src/js/modules/feedbackForm.js");
...
function calcFeedbackForm(url) {
  const firstStageForm = {
    ...
    getToNextStageBtn: function getToNextStageBtn() {
  ...
  const dataFeedback = {};
  let validateErrors = {};
  Object(_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_calc_btn", ".popup_calc", "block", function () {
    firstStageForm.getInputFields().getTypesBalconies().forEach(typeBalcony => {
      ...
      typeBalcony.addEventListener("click", () => {
        setTimeout(() => {
          // wait until tab module change activity class
  ...
  function secondStageFunc() {
    ...
    secondStageForm.getInputFields().getCheckboxCold().addEventListener("change", function () {
      if (dataFeedback["warm_glazing"]) dataFeedback["warm_glazing"] = false;
      dataFeedback[this.name] = this.value;
    });
    secondStageForm.getInputFields().getCheckboxWarm().addEventListener("change", function () {
      if (dataFeedback["cold_glazing"]) dataFeedback["cold_glazing"] = false;
      dataFeedback[this.name] = this.value;
    });
...
/***/ "./src/js/modules/feedbackForm.js":
/*!****************************************!*\
  !*** ./src/js/modules/feedbackForm.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./validate */ "./src/js/modules/validate.js");




function feedbackForm(formSelector, url, extraData = {}) {
  // отправляет только поля с тегом "input"
...
function setMaskPhoneNumber() {
  ...
  function eventCallback(e) {
    e.preventDefault(); // if (!e.isTrusted || e.type !== "input") {

    var el = e.target,
        clearVal = el.dataset.phoneClear,
        // затирание номера при потере фокуса
...
/* harmony default export */ __webpack_exports__["default"] = (setMaskPhoneNumber);
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: default, activateModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! validate */ "./node_modules/validate/build/schema.js");
/* harmony import */ var validate__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(validate__WEBPACK_IMPORTED_MODULE_1__);


const validateSchema = new validate__WEBPACK_IMPORTED_MODULE_1___default.a({
  name: {
    type: String,
    required: true,
    length: {
  ...
  phone: {
    type: String,
    required: true,
    // match: /^[\+]?[(]?[0-9]{3}[)]?[ ]?[0-9]{3}[-]?[0-9]{4,6}$/im,
    match: /^[+]7[(][0-9]{3}[)][ ][0-9]{3}[-]{1}[0-9]{2}[-]{1}[0-9]{2}/,
    // работа в связке с маской
    message: {
      required: "Обязательное поле",
...
/* harmony default export */ __webpack_exports__["default"] = (tryValidate);
